...
with open('smogomierztool/_buildid.py', 'w') as fd:
    fd.write('''# This file is autogenerated in smogomierz-tool.spec file
commit = "{commit}"
builddate = "{builddate}"'''.format(commit=commit, builddate=builddate))

a = Analysis(['smogomierz-tool.py'],
             pathex=['.'],
             binaries=[],
...
app = BUNDLE(exe,
             name='Smogomierz Flashing Tool.app',
